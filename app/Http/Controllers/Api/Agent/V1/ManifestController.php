    ...
    public function __invoke(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'endpoints' => [
                ...
                ['method' => 'GET', 'path' => $base.'/doctors/{slug}/slots', 'name' => 'doctors.slots', 'customer' => false, 'purpose' => 'Available slots. All query params optional: clinic_address_id, service_type_id, date. Returns options + resolved ids.'],
                ...
                ['method' => 'POST', 'path' => $base.'/customers/password/forgot', 'name' => 'customers.password.forgot', 'customer' => false, 'purpose' => 'Send a reset code/email. Returns 422 when the identifier is not registered.'],
                ...
                ['method' => 'POST', 'path' => $base.'/bookings', 'name' => 'bookings.store', 'customer' => true, 'purpose' => 'Create a booking. Body: doctor_slug, scheduled_at, optional clinic_address_id/service_type_id/patient_home_address/payment_mode.'],
